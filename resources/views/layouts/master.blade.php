...
<head>
    ...
    <link rel="shortcut icon" href="{{ url('assets/img/favicon.png') }}"><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.4.1/dist/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
    ...
    <link rel="stylesheet" href="{{ url('assets/css/bootstrap-datetimepicker.min.cs') }}s">
...
<body>
                    ...
                    <div class="dropdown-menu ">
                        <div class="noti-content">
                            <div>
                                ...
                                <a class="dropdown-item" href="javascript:;">
                                    <i class="flag flag-kh me-2"></i>Russia</a>
                            </div>
                        </div>
                    </div>
                </li>
    ...
    <script src="{{ url('assets/plugins/simple-calendar/jquery.simple-calendar.js') }}"></script>
    <script src="{{ url('assets/js/calander.js') }}"></script>
